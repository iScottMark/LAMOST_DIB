...
def load_dataset(config_path=data_config_path):
    # parse the config file
    with open(config_path, 'r') as f:
        config = yaml.safe_load(f)
    home: str = config['PATH']['home']
    work_dir: str = config['PATH']['work_dir']
    catalog_path: str = config['PATH']['catalog_path']

    lamost_general_catalog = Catalog(path=os.path.join(home, work_dir, catalog_path))
