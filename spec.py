...
from utils import assemble_path, shift_wave, vac2air, cut_array, rebin_array, specNormg
...
def get_spec_path(config_path: str):
    ...
    return os.path.join(home, work_dir, data_dir)
...
class Spectra(object):
    ...
    def spec_path(self):
        ...
        absolute_path = self.__data_dir + relative_path
